...
export class AutocompleteStatusBar {
	...
	private init() {
		this.statusBar.text = "StepClineComplete"
		this.statusBar.tooltip = "stepcline:autocomplete.statusBar.tooltip.basic"
		this.statusBar.command = "stepcline.toggleAutocomplete"
		this.show()
	}
	...
	private humanFormatCost(cost: number): string {
		if (cost === 0) return "stepcline:autocomplete.statusBar.cost.zero"
		if (cost > 0 && cost < 0.01) return "stepcline:autocomplete.statusBar.cost.lessThanCent" // Less than one cent
	...
	public update(params: AutocompleteStatusBarStateParams) {
		...
		this.lastCompletionCost = params.lastCompletionCost !== undefined ? params.lastCompletionCost : this.lastCompletionCost
		this.render()
	}

	private renderDisabled() {
		this.statusBar.text = "stepcline:autocomplete.statusBar.disabled"
		this.statusBar.tooltip = "stepcline:autocomplete.statusBar.tooltip.disabled"
	}

	private renderTokenError() {
		this.statusBar.text = "stepcline:autocomplete.statusBar.warning"
		this.statusBar.tooltip = "stepcline:autocomplete.statusBar.tooltip.tokenError"
	}
	...
	private renderDefault() {
		...
		this.statusBar.text = `"stepcline.statusBar.enabled" (${totalCostFormatted})`
		this.statusBar.tooltip = "stepcline tips"
	}
