 ...
 */
export const createInlineCompletionItem = (completionText: string, insertRange: vscode.Range): vscode.InlineCompletionItem => {
	return Object.assign(new vscode.InlineCompletionItem(completionText, insertRange), {
		command: {
			command: "stepcline.trackAcceptedSuggestion",
